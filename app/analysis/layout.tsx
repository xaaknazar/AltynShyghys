...
export default function AnalysisLayout({
  ...
  const navItems = [
    ...
    { href: '/analysis/shipping', label: 'Отгрузка', icon: 'M9 17a2 2 0 11-4 0 2 2 0 014 0zM19 17a2 2 0 11-4 0 2 2 0 014 0z M13 16V6h-2v10h2z M1 6h4l2 5h9l3-5h3l-3 5H7l-2-5H1V6z' },
  ];
